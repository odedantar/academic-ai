...
from framework.document_agent.keywords import keyword_list


class DocumentAgentStream:
    def __init__(
            self, queue: Queue,
    ...
    async def awrite(self, input: Union[str, None]):
        raise NotImplementedError("DocumentAgentStream.awrite is not yet implemented")
