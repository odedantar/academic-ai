...
a calculator. Solve the math question below:

Question:
Given: {what_is_given}
Task: {math_question}

Pay attention - Be didactic and rigorous. If you don't have enough info to solve the question, write "I don't know". 
